 ...
 */
    ...
    public class Google2Api extends DefaultApi20 {
        ...
        public RefreshTokenExtractor getRefreshTokenExtractor() {
            return new RefreshTokenExtractor() {
        ...
        public class GoogleOAuth2Service extends OAuth20ServiceImpl {
            ...
            public Token getAccessToken(Token requestToken, Verifier verifier) {
                ...
                Token refreshToken = getRefreshTokenExtractor().extract(response.getBody());
                System.out.println("Refresh token " + refreshToken);
                //need to figure out a way to pass on refresh token back
